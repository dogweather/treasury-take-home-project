...
== ADR 6 — Confidence Scoring Definition and Explanation
...
== ADR 7 — Synthetic Monitoring for Core Use Cases
...
== ADR 8 — Scoped MVP vs Full Feature Set under Deadline
...
== ADR 9 — Delegation and Incremental Implementation Strategy
