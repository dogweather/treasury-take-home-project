...
* Be simple and easy to use for a non-technical user. footnote:[Sarah Chen interview.]
...
* Upload one image file. footnote:[Implied by assignment scope.]
* Enter corresponding application form fields manually. footnote:[Marcus Williams interview.]
* Display the results of the comparison (see FR-UI-4). footnote:[Sarah Chen interview.]
...
* Accept multiple label files simultaneously. footnote:[Ibid.]
* Display individual results per label. footnote:[Ibid.]
* Provide a consolidated summary view of mismatches. footnote:[Ibid.]
...
For each label, the system shall display: footnote:[Additional Context section.]
...
The system shall return structured results in ≤ 5 seconds per label. footnote:[Sarah Chen interview.]
...
* Slightly rotated images footnote:[Jenny Park interview.]
* Moderate glare footnote:[Ibid.]
* Non-ideal lighting footnote:[Ibid.]
...
* Perform case-insensitive comparison. footnote:[Dave Morrison interview.]
* Potentially perform other "obviously the same" comparisons. footnote:[Ibid.]
* Flag substantive lexical differences. footnote:[Ibid.]
...
* Extract % ABV. footnote:[Sarah Chen interview.]
* Recognize proof equivalency (proof = ABV × 2 for spirits). footnote:[Additional Context section.]
...
* Extract volume measurement. footnote:[Ibid.]
...
* Must match word-for-word. footnote:[Jenny Park interview.]
* Must include "*GOVERNMENT WARNING:*" in all caps and bold. footnote:[Ibid.]
* Must detect deviation in wording. footnote:[Ibid.]
...
The system shall indicate when it's uncertain about an extraction and recommend manual review. footnote:[Jenny Park & Dave Morrison interviews.]
...
* Allow override of flagged mismatches. footnote:[Dave Morrison interview.]
...
* Process up to 300 labels in a batch. footnote:[Sarah Chen interview.]
* Maintain individual result records per label. footnote:[Ibid.]



==== FR-BATCH-2: Summary Reporting

The system shall provide enough information to the user to review the batch and determine which labels need to be reviewed manually. footnote:[Sarah Chen interview.]
...
The prototype shall not rely on outbound API calls to public ML endpoints. footnote:[Marcus Williams interview.]
...
* Be deployable within Azure environment. footnote:[Ibid.]
* Avoid architecture incompatible with government infrastructure. footnote:[Ibid.]
