...
* Upload one image file. footnote:[Source: Implied by assignment scope]
* Enter corresponding application form fields manually. footnote:[Source: Marcus Williams interview]
* Display the results of the comparison (see FR-UI-4). footnote:[Source: Sarah Chen interview]
